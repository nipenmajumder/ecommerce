...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Slider /</span> List
        </h4>
        <div class="card">
                                    ...
                                    <a href="{{route('slider.create')}}">
                                        <button class="btn btn-secondary btn-primary" tabindex="0"
                                                aria-controls="DataTables_Table_0" type="button"><span><i
                                                    ...
                                                    class="d-md-inline-block d-none">Create Slider</span></span>
                                        </button>
                                    </a>
                                </div>
                            </div>
                            ...
                            <tr class="odd">
                                ...
                                <td>
                                    ...
                                    <a href="{{route('slider.show',$slider->id)}}">
                                        <button @class(['btn btn-sm','btn-info' => $slider->status == 0,'btn-success' => $slider->status == 1,]) >
