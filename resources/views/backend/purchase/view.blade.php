                ...
                <div class="card invoice-preview-card">
                    <div class="card-body">
                        <div
                            ...
                            <div>
                                <h4>Invoice #{{$purchase->invoice}}</h4>
                                <div class="mb-2">
                                    <span class="me-1">Date</span>
                                    <span class="fw-semibold">{{ date('d-F-Y', strtotime($purchase->date)) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row p-sm-3 p-0">
                            <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
                                ...
                                <p class="mb-1">{{$purchase->user->name }}</p>
                                <p class="mb-1">Shelby Company Limited</p>
                                <p class="mb-1">Small Heath, B10 0HF, UK</p>
                                <p class="mb-1">{{$purchase->user->phone }}</p>
                    ...
                    <div class="table-responsive">
                        <table class="table border-top m-0">
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">{{$value->product->barcode}}</td>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-5">
                                    <p class="fw-semibold mb-2">${{$purchase->total}}</p>
                                    <p class="fw-semibold mb-2">{{$purchase->purchase_details_count}}</p>
                                    <p class="fw-semibold mb-0">${{$purchase->total}}</p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary d-grid w-100 mb-3" target="_blank"
