...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Author /</span> List
        </h4>
        <div class="card">
                                    ...
                                    <a href="{{route('author.create')}}">
                                        <button class="btn btn-secondary btn-primary" tabindex="0"
                                                aria-controls="DataTables_Table_0" type="button"><span><i
                                                    ...
                                                    class="d-md-inline-block d-none">Create Author</span></span>
                                        </button>
                                    </a>
                                </div>
                            </div>
                    ...
                    <table class="invoice-list-table table border-top dataTable no-footer dtr-column"
                        ...
                        @foreach($authors as $author)
                            <tr class="odd">
                                ...
                                <td>{{$author->slug}}</td>
                                <td>
                                    <img src="{{asset($author->avatar)}}" alt="" width="100px">
                                </td>
                                <td>
                                    @if($author->status == 1)
                                ...
                                <td>
                                    ...
                                    <a href="{{route('author.show',$author->id)}}">
                                        <button @class(['btn btn-sm','btn-info' => $author->status == 0,'btn-success' => $author->status == 1,]) >
