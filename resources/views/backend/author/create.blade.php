        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('author.store')}}" enctype="multipart/form-data" class="row">
                            @csrf
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="death-day">Deathday<span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="death-day" placeholder="deathday" name="death_day">
                                @error('death_day')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
